            ...
            <div className={styles.picProfilePet}>
              ...
              <div className={styles.continerTextProfilePet}>
                <p className={styles.textDescPet}>
                  Soy un gatito muy travieso, me gusta salir con los gatitos de
                  barrio, con mi novia y darnos unos besos. Noy fan de la leche
                  y mis laitas de carne. Pronto conquistaré el mundo.
                </p>
              </div>
            </div>
          </div>
